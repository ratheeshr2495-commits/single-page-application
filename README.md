...
	Responsive Redesign:
 	Make UI fully adaptive for mobile, tablet, and desktop.
...
	Performance Testing:
 	Use Lighthouse, GTMetrix, or WebPageTest for page speed insights.
	Security Testing:
...
3.Routing :
	SPA routing controls navigation without reloading the page.
